...
function addComplaint() {
  ...
  var date = new Date();
  // Format the date as 
  var formattedDate = date.toLocaleDateString('en-US', { day: 'numeric', month: 'numeric', year: 'numeric' });
  // Create a new row for the complaint
  var row = document.createElement('tr');
  row.innerHTML = '<td>' + formattedDate + '</td><td>' + complaintMessage + '</td>';
  // Add the new row to the table
  document.getElementById('complaintsTable').appendChild(row);
}
